...
- Home keeps Refresh inside the companion card beside the prominent Pokémon name, without a redundant Current companion heading. Evolution details use a quieter, readable secondary tone. The animated companion sits in a large square frame with equal inner margins, and all progress content stays inside the card.
